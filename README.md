...
## Prepare dataset
The preparation process of the dataset refers to [OVSegmentor](https://github.com/Jazzcharles/OVSegmentor). We provide the [GID dataset](https://drive.google.com/file/d/1g30ldLFhJaqPTTxPHIZYRWnREwFKZf77/view?usp=sharing) divided into 256✕256 as example data to show the preprocessing process.
